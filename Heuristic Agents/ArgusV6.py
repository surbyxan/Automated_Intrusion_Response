...
class ArgusV6(BaseAgent):
    ...
    def __init__(self):
        ...
        self.DecoyPriority = [
            ...
            ('Enterprise1', 'decoy_tomcat', 0), 
            ('Enterprise2', 'decoy_tomcat', 0), 
            ('Enterprise1', 'decoy_vsftpd', 0), 
            ('Enterprise2', 'decoy_vsftpd', 0), 
            ('Enterprise1', 'decoy_smss', 0), 
            ('Enterprise2', 'decoy_smss', 0), 
            ('Enterprise1', 'decoy_svchost', 0), 
            ('Enterprise2', 'decoy_svchost', 0), 
            ('Op_Server0', 'decoy_apache', 0), 
            ('Op_Server0', 'decoy_tomcat', 0), 
            ('Op_Server0', 'decoy_vsftpd', 0), 
            ('Op_Server0', 'decoy_smss', 0), 
            ('Op_Server0', 'decoy_svchost', 0), 
            ('User1', 'decoy_apache', 0),
            ('User1', 'decoy_tomcat', 0),
            ('User1', 'decoy_vsftpd', 0),
            ('User1', 'decoy_smss', 0),
            ('User1', 'decoy_svchost', 0),
            ('User2', 'decoy_tomcat', 0),
            ('User2', 'decoy_vsftpd', 0),
            ('User3', 'decoy_smss', 0),
            ('User4', 'decoy_smss', 0),
            ('User4', 'decoy_svchost', 0),
        ]
    ...
    def get_action(self, observation, action_space):
        ...
        # Deploy renaining decoys even if portscanned or not netscanned
        for i, (host_name, decoy, decoy_flag) in enumerate(self.DecoyPriority):
            offset = Offsets.VECTOR_HOST_OFFSETS[host_name]
